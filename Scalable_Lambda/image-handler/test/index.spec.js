...
describe("index", () => {
    ...
    it("should return the image when there is no error", () => __awaiter(void 0, void 0, void 0, function* () {
        // Mock
    ...
    it("should return the image with custom headers when custom headers are provided", () => __awaiter(void 0, void 0, void 0, function* () {
        // Mock
        mock_1.mockAwsS3.getObject.mockImplementationOnce(() => ({
            promise() {
                return Promise.resolve({ Body: mockImage, ContentType: "image/jpeg" });
    ...
    it("should return the image when the request is from ALB", () => __awaiter(void 0, void 0, void 0, function* () {
        // Mock
        mock_1.mockAwsS3.getObject.mockImplementationOnce(() => ({
            promise() {
                return Promise.resolve({ Body: mockImage, ContentType: "image/jpeg" });
    ...
    it("should return an error JSON when an error occurs", () => __awaiter(void 0, void 0, void 0, function* () {
        // Arrange
        const event = { path: "/test.jpg" };
        // Mock
        mock_1.mockAwsS3.getObject.mockImplementationOnce(() => ({
    ...
    it("should return 500 error when there is no error status in the error", () => __awaiter(void 0, void 0, void 0, function* () {
        // Arrange
        const event = {
    ...
    it("should return the default fallback image when an error occurs if the default fallback image is enabled", () => __awaiter(void 0, void 0, void 0, function* () {
        // Arrange
        ...
        // Assert
        expect(mock_1.mockAwsS3.getObject).toHaveBeenNthCalledWith(1, {
            Bucket: "source-bucket",
            Key: "test.jpg",
        });
        expect(mock_1.mockAwsS3.getObject).toHaveBeenNthCalledWith(2, {
            Bucket: "fallback-image-bucket",
            Key: "fallback-image.png",
        });
        expect(result).toEqual(expectedResult);
    }));
    it("should return an error JSON when getting the default fallback image fails if the default fallback image is enabled", () => __awaiter(void 0, void 0, void 0, function* () {
        // Arrange
        const event = {
            path: "/test.jpg",
        };
    ...
    it("should return an error JSON when the default fallback image key is not provided if the default fallback image is enabled", () => __awaiter(void 0, void 0, void 0, function* () {
        // Arrange
    ...
    it("should return an error JSON when the default fallback image bucket is not provided if the default fallback image is enabled", () => __awaiter(void 0, void 0, void 0, function* () {
        // Arrange
    ...
    it("Should return an error JSON when ALB request is failed", () => __awaiter(void 0, void 0, void 0, function* () {
        // Arrange
        const event = {
            path: "/test.jpg",
            requestContext: {
